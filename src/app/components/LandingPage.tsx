...
export function LandingPage({ onStartQuiz }: LandingPageProps) {
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50">
            {/* Navbar */}
            <Navbar onStartQuiz={onStartQuiz} />
            ...
            {/* Categories Section */}
            <div id="categories" className="bg-gradient-to-br from-blue-600 to-blue-700 py-16 sm:py-24">
            ...
            {/* Testimonials */}
            <div id="testimonials" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
                <div className="text-center mb-16">
                    <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
